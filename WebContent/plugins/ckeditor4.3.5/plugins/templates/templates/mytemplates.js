...
CKEDITOR.addTemplates( "custom", {
	...
	templates: [
	{
		...
		'</head>'+
		'<body class="dottedbody" style="padding: 15mm; transform-origin: left top 0px; width: 185mm; font-family: TH SarabunPSK; font-size: 22px; margin-left: 0mm; min-height: 29.7cm; max-width: 21cm; transform: scale(1); background-color: rgb(255, 255, 255);">'+
		'<table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">'+
		'<tbody>'+
		'<tr>'+
		'<td style="width: 40%; text-align: left; vertical-align: top;"><span style="font-size: 22px;"><span style="font-family: &quot;TH SarabunPSK&quot;;"><strong></span>&#3588;&#3635;&#3619;&#3657;&#3629;&#3591;</strong><br />'+
		...
		'&nbsp;</td>'+
		'<td style="width: 20%; text-align: center; vertical-align: middle;"><span style="font-size: 22px;"><img alt="" src="'+CKEDITOR.getUrl( CKEDITOR.plugins.getPath( "templates" ) + "templates/images/icon_samut.jpg" )+'" /></span></td>'+
		'<td style="width: 40%; text-align: right; vertical-align: top;"><span style="font-size: 22px;"><span style="font-family: &quot;TH SarabunPSK&quot;;"><strong>&#3621;.&#3672;<br />'+
