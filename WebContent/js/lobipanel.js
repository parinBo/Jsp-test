...
//------------------------------------------------------------------------------
    ...
    $.fn.lobiPanel.DEFAULTS = {
        ...
        expand: {
            icon: 'glyphicon glyphicon-fullscreen', //icon is shown when panel is not on full screen //glyphicon-resize-full
            icon2: 'glyphicon glyphicon-resize-small', //icon2 is shown when pane is on full screen state //glyphicon-resize-small
